...
namespace IAG.VinX.Chardonnens.Shop.v10.DtoDirect;

/// <summary>
/// Articles with customer extensions
/// </summary>
[DataContract]
[DisplayName("ArticleCefs")]
[TableCte(@"
       WITH ArticleCefs
        AS
        (
        SELECT 
            ...
            DDProduct_ContentInfo               AS IngredientsInformation,
            DDProduct_AllergenInfo              AS AllergenicsInformation,
            DDProduct_NahrungsInfo              AS NutritionInformation,
        ...
        LEFT OUTER JOIN DDBundle ON DDBundle_ID=Art_DDBundleID
        LEFT OUTER JOIN DDProduct ON DDProduct_ID=DDBundle_DDProductID
        )
    ")]
public class ArticleCefs: ArticleV10 
{
    /// <summary>
    ...
    /// <summary>
    /// Ingredients information, DDProduct_ContentInfo 
    /// </summary>
    [DataMember(Name = "ingredientsInformation")]
    public string IngredientsInformation { get; set; }
    
    /// <summary>
    /// Allergenics information, DDProduct_AllergenInfo
    /// </summary>
    [DataMember(Name = "allergenicsInformation")]
    public string AllergenicsInformation { get; set; }
    
    /// <summary>
    /// Nutrition information, DDProduct_NahrungsInfo
    /// </summary>
    [DataMember(Name = "nutritionInformation")]
