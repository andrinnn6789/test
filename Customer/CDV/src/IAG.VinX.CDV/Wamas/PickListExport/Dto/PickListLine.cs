   ...
   WITH
        ...
        (
            SELECT
                ...
                BelPos_MengeAbf                             AS PickListQuantity,
...
[DelimitedRecord(";")]
public class PickListLine : IWamasRecord
{
    ...
    [NotMapped] public string DatasetType { get; set; } = ResourceIds.WamasPickListLineRecordType;
    ...
    [NotMapped] public string TargetGoodsOwner { get; set; }

    [NotMapped] public string Batch { get; set; }

    [NotMapped] public string RemainingLife { get; set; }

    [NotMapped] public string RemainingLifeUnit { get; set; }
    ...
    [NotMapped] public string PickListLuId { get; set; }

    public decimal PickListQuantity { get; set; }

    [NotMapped] public string PickingGroup { get; set; }
    ...
    [NotMapped] public string RequestedDeliveryDateTo { get; set; }

    [NotMapped] public string WholeWarehouseQuantityUnits { get; set; } = "YES";
    ...
    [NotMapped] public string SapPlant { get; set; }

    [NotMapped] public string SapStorageLocation { get; set; }

    [NotMapped] public string SapStockType { get; set; }

    [NotMapped] public string SapSpecStock { get; set; }
