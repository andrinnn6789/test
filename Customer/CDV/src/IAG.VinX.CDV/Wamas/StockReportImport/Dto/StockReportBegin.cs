...
[DelimitedRecord(";")]
public class StockReportBegin : IWamasRecord
{
    ...
    [FieldHidden]
    [FieldValueDiscarded]
    public List<StockReportAcknowledge> StockReportAcknowledges { get; set; } = new();

    [FieldHidden] public StockReportEnd StockReportEnd { get; set; }
}